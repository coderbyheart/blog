...
[![Happieness]({{ '/uploads/dilbert-happy-2015-10-16.gif' | prepend:site.baseurl | prepend:site.url }})](http://dilbert.com/strip/2015-10-16)
...
what my day to day work should look like. In the past, I've already written about [what I am looking for in an employer]({{ '/leaving-dothiv' | prepend:site.baseurl | prepend:site.url }}) 
and gave advice on [How to find a CTO]({{ '/how-to-find-a-cto' | prepend:site.baseurl | prepend:site.url }}); both posts emphasize on the *circumstances* that create great 
